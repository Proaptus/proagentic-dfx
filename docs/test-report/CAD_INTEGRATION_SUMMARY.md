...
title: "OpenCascade.js CAD Integration - Research Summary"
version: 1.0.0
date: 2025-12-09
owner: "@h2-tank-team"
status: accepted
...
- âŒ **BAD**: Uses `THREE.LatheGeometry` - just triangulated meshes, NOT CAD solids
- âŒ **BAD**: No B-rep topology, no design intent, no parametric constraints
- âŒ **BAD**: Cannot export to STEP/IGES (critical for engineering workflows)
