/**
 * Constants and default data for FailureAnalysisPanel
...
export function buildFailureEnvelopeData(
  failureData: DesignFailure,
  hashinCriteria: Array<{ mode: string; value: number }>
): RadarDesignData[] {
  return [
    {
      designId: 'hashin',
